...
namespace gazebo {
    ...
    class GZ_PLUGIN_VISIBLE LiftDragPluginWithWind
    
    : public ModelPlugin {
    /// \brief Constructor.
    public:
    
    LiftDragPluginWithWind();
    ...
    void windVelocityCallback(ConstWindPtr &msg);
    ...
    protected:
    ignition::math::Vector3d windVelocity;
    ...
    transport::SubscriberPtr windSubscriber;
};
}
#endif